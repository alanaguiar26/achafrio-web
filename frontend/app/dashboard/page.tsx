    ...
    <div className="grid gap-6">
      <section className="glass rounded-[30px] border p-7 md:p-8">
        <div className="flex flex-wrap items-start justify-between gap-5">
          <div>
            <div className="text-sm font-black uppercase tracking-[0.18em] text-cyan-200">Visão geral</div>
            <h1 className="mt-3 text-3xl font-black text-white">Olá, {data.name}.</h1>
      ...
      <section className="grid gap-6 lg:grid-cols-[1fr_0.92fr]">
        <div className="glass rounded-[30px] border p-7">
          <div className="text-sm font-black uppercase tracking-[0.18em] text-cyan-200">Próximas ações</div>
        ...
        <div className="glass rounded-[30px] border p-7">
          <div className="flex items-center justify-between gap-3">
            <div>
              <div className="text-sm font-black uppercase tracking-[0.18em] text-cyan-200">Leads</div>
              <div className="mt-2 text-2xl font-black text-white">{pendingQuotes} orçamento(s) novos</div>
            </div>
