...
export function Footer() {
  return (
    <footer className="mt-24 border-t border-white/6 bg-slate-950/68">
      <div className="container-app py-10 md:py-14">
        <div className="glass mb-8 rounded-[30px] border p-6 md:flex md:items-center md:justify-between md:gap-6 md:p-8">
          <div>
            <div className="eyebrow">Pronto para crescer</div>
            <h2 className="section-title-sm mt-4 max-w-2xl">Transforme o seu perfil em uma vitrine que passa confiança e gera contato.</h2>
          </div>
        ...
        <div className="footer-grid">
          <div>
            ...
            <p className="mt-4 max-w-xl text-sm leading-7 text-slate-400">
              Plataforma para técnicos e empresas de ar-condicionado e refrigeração conquistarem mais visibilidade, mais confiança e mais oportunidades.
            </p>
          ...
          <div>
            <div className="text-sm font-bold uppercase tracking-[0.18em] text-cyan-200">Para o profissional</div>
            <div className="mt-4 grid gap-3 text-sm text-slate-400">
          ...
          <div>
            <div className="text-sm font-bold uppercase tracking-[0.18em] text-cyan-200">Comercial</div>
            <div className="mt-4 grid gap-3 text-sm text-slate-400">
